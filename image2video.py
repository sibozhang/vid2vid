...
# my_clip.write_videofile('./results/{person}/shared_video_output/{person}_{audio}.mp4'.format(person=person, audio=file_name),
#                         audio='../VisualVirtualCharacter/input_audio/{person}/{audio}.mp3'.format(person=person,audio=file_name))
...
my_clip.write_videofile('./results/{person}/shared_video_output/{person}_smooth_{audio}.mp4'.format(person=person, audio=file_name),
                        audio='../Text2Video/input_audio/{person}/{audio}.mp3'.format(person=person,audio=file_name))
